        ...
        <div className="flex flex-col min-h-screen animate-fade-in">
            ...
            <main className="flex-1 flex flex-col justify-center items-center px-6 pb-12 w-full max-w-sm mx-auto">
                ...
                <div className="flex flex-col w-full gap-3">
                    <button
                        onClick={onPlayAgain}
                        className="w-full flex items-center justify-center gap-2 h-14 bg-primary text-on-primary text-base font-black rounded-xl active:scale-[0.98]"
                    >
                        <span className="material-symbols-outlined text-xl text-on-primary">refresh</span>
